...
export const categoryFilterConfig = {
  ...
  FURNITURE: [
    ...
    { key: 'colour', label: 'Colour', type: FILTER_TYPES.TEXT, deriveOptions: true, fallbacks: ['color'] },
    { key: 'seatingCapacity', label: 'Seating Capacity', type: FILTER_TYPES.TEXT, deriveOptions: true },
  ...
  JEWELLERY_AND_WATCHES: [
    ...
    { key: 'boxAndPapers', label: 'Box & Papers', type: FILTER_TYPES.SELECT, options: ['Available', 'Not Available'] },
  ...
  TO_LET: [
    ...
    { key: 'monthlyRent', label: 'Rent Range', type: FILTER_TYPES.RANGE, unit: '₹' },
